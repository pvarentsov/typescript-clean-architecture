...
describe('Post.GetCommonList', () => {
  ...
  describe('GET /posts', () => {
    ...
    test('When author requests common post list, expect it returns list with only published posts', async () => {
      await expectItReturnsListWithPublishedPost(UserRole.AUTHOR, testServer, userFixture, postFixture);
    });
  
    test('When admin requests common post list, expect it returns list with only published posts', async () => {
      await expectItReturnsListWithPublishedPost(UserRole.ADMIN, testServer, userFixture, postFixture);
    });
  
    test('When guest requests common post list, expect it returns list with only published posts', async () => {
      await expectItReturnsListWithPublishedPost(UserRole.GUEST, testServer, userFixture, postFixture);
    });
...
async function expectItReturnsListWithPublishedPost(
